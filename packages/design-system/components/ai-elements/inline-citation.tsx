...
export const InlineCitationSource = ({
  ...
  <div className={cn("space-y-1", className)} {...props}>
    {url ? (
      ...
      >
        {title && (
          <h4 className="truncate font-medium text-sm leading-tight group-hover:underline">
            {title}
          </h4>
        )}
        <p className="truncate break-all text-muted-foreground text-xs group-hover:underline">
          {url}
        </p>
      </a>
    ) : (
